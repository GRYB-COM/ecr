...
void FieldMaskFCTR::setMessage(Message& _Mess, const AnsiString& _MessStr) const
{
	...
	Globals::MessID _MI;
	if (_Mess.getMessID() == Globals::miUnknown)
		_MI = static_cast<Globals::MessID>(_Fields.getAsInt(1));
	else
		_MI= _Mess.getMessID();
	MessStructFCTR::const_iterator _Kinds = MessStructFCTR::instance().find(_MI);
	if (_Kinds == MessStructFCTR::instance().end())
		_Kinds = MessStructFCTR::instance().find(Globals::miUnknown);
	...
	for (_ItB; _ItB != _Kinds->second.end(); ++_ItB)
	{
		_ItFM = find(*_ItB);
		if (_ItFM != end())
			_ItFM->second->setMessage(_Mess, _Fields, _Idx);
		++_Idx;
	}
}
...
{
	operator[](Globals::miUnknown) += Globals::fkMessID, Globals::fkNull;
	operator[](Globals::miECRHello) += Globals::fkMessID, Globals::fkCipher, Globals::fkNull, Globals::fkNull, Globals::fkNull, Globals::fkNull, Globals::fkNull;
	operator[](Globals::miPOSHello) += Globals::fkMessID, Globals::fkTermStatus, Globals::fkNull, Globals::fkNull, Globals::fkTermID;
	operator[](Globals::miECRStart) += Globals::fkMessID, Globals::fkTransType, Globals::fkAmount, Globals::fkNull, Globals::fkNull, Globals::fkNull,
		 Globals::fkNull, Globals::fkPLN, Globals::fkNull, Globals::fkNull, Globals::fkNull;
	operator[](Globals::miECRStartExt) += Globals::fkMessID, Globals::fkTransType, Globals::fkZero, Globals::fkAmount, Globals::fkNull, Globals::fkNull,
	...
	operator[](Globals::miPOSFinish) += Globals::fkMessID, Globals::fkNull, Globals::fkCardType, Globals::fkTransStatus, Globals::fkNull, Globals::fkNull;
	operator[](Globals::miPinPadDisp) += Globals::fkMessID, Globals::fkPPMSize, Globals::fkPPMsg, Globals::fkNull, Globals::fkPPMResp, Globals::fkTimeOut;
	operator[](Globals::miECRDisp) += Globals::fkMessID, Globals::fkPPMResp, Globals::fkPPMSize, Globals::fkPPMsg, Globals::fkNull;
	operator[](Globals::miECRPrompt) += Globals::fkMessID, Globals::fkPromptReq, Globals::fkPPMSize, Globals::fkPPMsg, Globals::fkNull;

	operator[](Globals::miPOSPrompt) += Globals::fkMessID, Globals::fkPromptReq, Globals::fkPPMSize, Globals::fkPPMsg, Globals::fkNull;
